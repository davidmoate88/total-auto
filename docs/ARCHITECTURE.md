...
| `calcs/structural/` | Structural calc modules (EN 1992/1993/1995) | **Three modules built** — `beam_capacity.py` (EN 1993-1-1 bending/shear/deflection), `column_capacity.py` (EN 1993-1-1 axial buckling resistance, both principal axes), `bolted_shear_connection.py` (EN 1993-1-8 concentric bolt group shear/bearing). All verified, none wired into the Streamlit UI. Combined bending+axial (SS6.3.3), block tearing, base plate/HD bolt design, and moment connections not yet built |
